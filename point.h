...
public:
	...
	void moveX(int x_value) { SetX(x_value + x); };
	void moveX(float x_value) { SetX(x_value + x); };
	void moveY(int y_value) { SetY(y_value + y); };
	void moveY(float y_value) { SetY(y_value + y); };
